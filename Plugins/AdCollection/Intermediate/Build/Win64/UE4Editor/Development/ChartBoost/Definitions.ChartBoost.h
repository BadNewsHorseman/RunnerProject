...
#define ORIGINAL_FILE_NAME "UE4Editor-ChartBoost.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME ProjectRunner
...
#define ADCOLLECTION_API DLLIMPORT
#define CHARTBOOST_API DLLEXPORT
